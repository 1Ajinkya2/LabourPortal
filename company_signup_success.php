...
$username = $_POST['form-register-company-username'];
$email = $_POST['form-register-company-email'];
$password = $_POST['form-register-company-password'];
$companyName = $_POST['form-register-company-name'];
$vat = $_POST['form-register-company-vat'];
$website = $_POST['form-register-company-website'];
$addressLine = $_POST["form_register_company_address_line"];

if($link){
    $query1 = "INSERT INTO `company_sign_up_data` (`username`, `company_name`, `email`, `vat_no`, `password`, `website`, `address_line`) VALUES ('".$username."', '".$companyName."', '".$email."', '".$vat."', '".$password."', '".$website."', '".$addressLine."')";

    $query2 = "INSERT INTO `company_login_data` (`username`, `password`) VALUES ('".$username."', '".$password."')";
