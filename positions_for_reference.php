...
<!-- Mirrored from preview.byaviators.com/template/profession/positions.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Aug 2018 11:09:11 GMT -->
<head>
    <meta charset="UTF-8">
...
<div class="row">
    ...
    <form method="post" action="">
        ...
        <div class="checkbox">
            <label><input type="radio" name="post" value="Data Mining">Data
            Mining</label>
        </div>
    ...
    <div class="col-sm-7">
        <div class="positions-list">
                ...
                <div class="positions-list-item">
                    <h2>
                        <a href="position-detail.php">Senior Data</a>

                            <span>Featured</span>

                    </h2>
                    <h3><i class="fa fa-map-marker"></i> San Francisco, Dropbox <br></h3>

                    <h3><i class="fa fa-user"></i>Company name<br></h3>

                    <div class="position-list-item-date">10/11/2015</div><!-- /.position-list-item-date -->
                    <div class="position-list-item-action"><a href="#">Apply</a></div><!-- /.position-list-item-action -->
                </div><!-- /.position-list-item -->

                <div class="positions-list-item">
                    <h2>
                        <a href="position-detail.php">Junior Java Developer</a>
                ...
                <div class="positions-list-item">
                    <h2>
                        <a href="position-detail.php">PR Manager</a>
                ...
                <div class="positions-list-item">
                    <h2>
                        <a href="position-detail.php">Data Mining Specialist</a>
                ...
                <div class="positions-list-item">
                    <h2>
                        <a href="position-detail.php">Python Developer</a>
