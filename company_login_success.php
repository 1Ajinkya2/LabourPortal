<?php
    ...
    $username = $_POST['form-login-company-username'];
    $password = $_POST['form-login-company-password'];

    if($link){

    $query = "SELECT `password` FROM `company_sign_up_data` WHERE `username` = '".$username."'";
        ...
        <div class="main">
            <div class="document-title">
                <div class="container">
                    ...
                    <?php
                        if($check1){
                        echo "<h1 class='center'>Login Successfull</h1>";
                    }
                    else{
                        echo "<h1 class='center'>Login Failed</h1>";
                }
                    ?>
            ...
            <?php
                if($check){
                echo "<a href='company_login.php' style='margin-left: 430px;' class='hero-content-action'>Login Again</a>";
            }
