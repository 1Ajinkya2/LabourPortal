...
<head>
    ...
    <title>Profession - Company Login</title>
</head>
...
<div class="page-wrapper">
    ...
    <div class="main-wrapper">
        <div class="main">
            <div class="document-title">
                <div class="container">
                    <h1 class="center">Company Login</h1>
                </div><!-- /.container -->
            </div><!-- /.document-title -->
	...
	<div class="row">
		<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
			<form method="post" action="company_login_success.php">
				<div class="form-group">
					<label for="form-login-username">Username</label>
					<input type="text" class="form-control" id="form-login-company-username" name="form-login-company-username">
				</div><!-- /.form-group -->

				<div class="form-group">
					<label for="form-login-password">Password</label>
					<input type="password" class="form-control" id="form-login-company-password" name="form-login-company-password">
				</div><!-- /.form-group -->
